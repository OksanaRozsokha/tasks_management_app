...
void main() {
  final taskEntity1 = TaskEntity.create(title: 'First task', isCompleted: false);
  final taskEntity2 = TaskEntity.create(title: 'Second task', isCompleted: false, description: 'test description', completionDate: 1628802000000);
  group('Ram Repository', () {
    ...
    test('Get tasks from storage', ()  {
      final expactedTasksList = [TaskEntity.create(id: 1, isCompleted: false, title: 'First task') , TaskEntity.create(id: 2, isCompleted: false, title: 'Second task', description: 'test description', completionDate: 1628802000000)];
